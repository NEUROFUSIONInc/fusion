...
export default function Root() {
  ...
  useEffect(() => {
    if (!neurositySelectedDevice) {
      alert(
        "Looks like you haven't connected a Neurosity device yet. Redirecting you to the setting page to continue"
      );
          ...
          <main style={{ marginLeft: "12%", paddingLeft: "10px" }}>
            ...
            <div id="record-experiment">
              ...
              {deviceStatus !== "online" ? (
                <div>
                  <p>
                    You need to be logged in with device turned on to record an
                    experiment
                  </p>
                </div>
              ) : (
                <>
                  ...
                  <p>
                    Go to <a href="/recordings">recordings tab</a> to see your
                    history
                  </p>
                  <ul>
