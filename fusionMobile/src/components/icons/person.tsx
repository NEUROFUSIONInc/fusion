    ...
    <Svg width={26} height={26} viewBox="0 0 26 26" fill="none" {...props}>
      <G id="Frame 848">
        <G clipPath="url(#clip0_101_705)">
          <Circle id="Ellipse 5" cx="13" cy="12" r="3.5" stroke={color} />
          <Circle id="Ellipse 6" cx="13" cy="27" r="8.5" stroke={color} />
        </G>
        <Rect x="0.5" y="0.5" width="25" height="25" rx="12.5" stroke={color} />
      </G>
      <Defs>
