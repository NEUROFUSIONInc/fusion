...
export const Sidebar: FC = () => {
  ...
  return (
    <aside
      className="max-w-64 flex h-screen w-full flex-col border-r-gray-200 bg-white px-5 py-7 transition-transform dark:border-r-slate-800/70 dark:bg-slate-800/25 md:border-r lg:w-72"
      aria-label="Sidebar"
    >
