...
interface CustomLinkProps
  ...
  store?: "apple" | "google" | "github" | "discord" | "docs";
}
...
export const CustomLink: FC<CustomLinkProps> = ({ variant, store = "apple", className, ...props }) => {
  ...
  function getStoreInfo(store: "apple" | "google" | "github" | "discord" | "docs") {
    switch (store) {
      case "apple":
        return {
      ...
      case "docs":
        return {
          href: "https://neurofusionresearchinc.mintlify.app/createquests",
          icon: (
